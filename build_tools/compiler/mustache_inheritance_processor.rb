...
module Compiler
  class MustacheInheritanceProcessor < TemplateProcessor
    ...
    @@yield_hash = {
      ...
      homepage_url:         tag_for(:homepageUrl, "https://www.hackney.gov.uk/"),
      ...
      page_title:           tag_for(:pageTitle, "Hackney Council"),
      ...
      logo_link_title:      tag_for(:logoLinkTitle, 'Go to the Hackney Council homepage'),
      ...
      hackney_copyright_message: tag_for(:hackneyCopyrightMessage, '&copy; London Borough of Hackney'),
    }
