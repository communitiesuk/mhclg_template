...
When we make changes to hackney_template, we want to know that the changes don't break integration with clients.
...
* pulls in the relevant built package from `pkg/`, (or the compiled template from `hackney_template/app`)
